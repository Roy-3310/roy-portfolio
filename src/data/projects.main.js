export const mainProject = {
  ...
  description:
    "整合商品、菜單、運動/跑步規劃等模組，強調使用者體驗、資料建模與前後端串接。以元件化架構打造可擴充的產品型網站。",
  tech: ["React", "TypeScript", "Vite", "SCSS", "Node.js", "MongoDB", "n8n"],
  webLink: "https://fit-meal-life-frontend.vercel.app/",
  highlights: [
    "多角色/多模組資訊架構設計（會員/管理/內容/購物流程）",
    "RWD 版型與一致的 UI 元件語言",
